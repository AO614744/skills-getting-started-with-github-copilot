...
activities = {
    ...
    "Swimming Club": {
        "description": "Swim laps, learn strokes, and compete in local meets",
    ...
    "Drama Club": {
        "description": "Practice acting, production, and stagecraft for school performances",
    ...
    "Debate Team": {
        "description": "Develop public speaking and argumentation skills for tournaments",
